...
using System.Linq;
using Test_List.Views.Student.ORMDataModel1;
...
{
    public static class ORMDataModel1SystemTextJsonExtensions
    {
        public static IServiceCollection AddORMDataModel1JsonOptions(this IServiceCollection builder)
        {
